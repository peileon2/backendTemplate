...
Revision ID: 6c2858babb71
Revises: 
Create Date: 2024-08-22 14:41:45.307269
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("peak_os_charge", sa.Float(), nullable=False),
        sa.Column("peak_rdc_charge", sa.Float(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["delivery_version_id"],
            ["assemble_delivery_fees.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("delivery_version_id"),
    )
    op.create_table(
        "ahs",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "ahs_type",
            sa.Enum("AHS_Dimension", "AHS_Weight", "AHS_Packing", name="ahstype"),
            nullable=False,
        ),
        sa.Column(
            "gd_hd_type",
            sa.Enum("GROUND", "HOMEDELIVERY", name="gdandhd"),
            nullable=False,
        ),
        sa.Column(
            "res_comm_type",
            sa.Enum("RESIDENTIAL", "COMMERCIAL", name="resandcomm"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "das_type", sa.Enum("DAS", "DASE", "RAS", name="dastype"), nullable=False
        ),
        sa.Column(
            "gd_hd_type",
            sa.Enum("GROUND", "HOMEDELIVERY", name="gdandhd"),
