...
class AssembleDeliveryFees(Base):
    ...
    # 一对多表
    base_rates = relationship("BaseRate", back_populates="delivery_version", cascade="all, delete-orphan")
    das_items = relationship("Das", back_populates="delivery_version", cascade="all, delete-orphan")
    oversizes = relationship("Oversize", back_populates="delivery_version", cascade="all, delete-orphan")
    ahs_items = relationship("Ahs", back_populates="delivery_version", cascade="all, delete-orphan")
    rdc_items = relationship("Rdc", back_populates="delivery_version", cascade="all, delete-orphan")
